...
func (i createPvcAction) Handle(ctx context.Context, instance *rhtasv1alpha1.Trillian) *action.Result {
	...
	pvc := k8sutils.CreatePVC(instance.Namespace, instance.Spec.Db.Pvc.Name, instance.Spec.Db.Pvc.Size, constants.LabelsFor(actions2.ComponentName, actions2.DbDeploymentName, instance.Name))
